...
echo ""
echo "Next steps:"
echo "  1. Generate an enrollment token in the Spectre web UI"
echo "  2. Enroll and start the agent as a service:"
echo ""
echo "     sudo spectre-agent up --host wss://<server-host> --enroll <token>"
echo ""
